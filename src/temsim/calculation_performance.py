...
_STAGE_LABELS = {
    ...
    "Resolving the EDS point spectrum": "EDS",
    "Restoring the cached EDS point spectrum": "Cached EDS spectrum",
    "Updating EDS dose and spectral readout": "EDS dose and spectral readout",
