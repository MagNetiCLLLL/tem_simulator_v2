> Historical archive, retained on 2026-09-19. Read [HANDOFF.md](HANDOFF.md)
> for current scope, status and next steps. Every instruction, test count,
> continuation request and shutdown reference below belongs to its recorded
> historical context. Coherent development is currently paused; none of these
> entries authorizes restarting it or shutting down the computer.
